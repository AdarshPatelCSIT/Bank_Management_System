...
public class Signupone extends JFrame implements ActionListener {
    ...
    JButton next;
    JRadioButton male, female, other, other_s, married, unmarried;
    ...
    Signupone() {
        ...
        personelDetails.setBounds(290, 80, 400, 30);
        add(personelDetails);
        ...
        other_s = new JRadioButton("Other");
        other_s.setBounds(630, 290, 100, 30);
        other_s.setBackground(Color.white);
        add(other_s);

        ButtonGroup gendergroup = new ButtonGroup();
        gendergroup.add(male);
        gendergroup.add(female);
        gendergroup.add(other_s);
